...
def arange(start: Scalar,
           stop: Scalar = 0,
           step: Scalar = 1,
           dtype: Any = None) -> ndarray[Scalar]:
    ...
...
def allclose(a: _ArrayLike[Scalar],
             b: _ArrayLike[Scalar],
             rtol: float = 1e-05,
             atol: float = 1e-08,
...
def dot(a: _ArrayLike[Scalar],
        b: _ArrayLike[Scalar],
        out: ndarray[Scalar] = None) -> ndarray[Scalar]:
    ...


def inner(a: _ArrayLike[Scalar], b: _ArrayLike[Scalar]) -> ndarray[Scalar]:
    ...


def outer(a: _ArrayLike[Scalar],
          b: _ArrayLike[Scalar],
          out: ndarray[Scalar] = None) -> ndarray[Scalar]:
    ...
...
def einsum(subscripts: str,
           *operands: _ArrayLike[Scalar],
           out: ndarray[Scalar] = None,
           dtype: Any = None,
           order: str = 'K',
           casting: str = 'safe',
           optimize: Any = False) -> ndarray[Scalar]:
    ...
